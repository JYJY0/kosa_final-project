...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/animate.css"/>">
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/fonticons.css"/>">
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/font-awesome.min.css"/>">
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/bootstrap.css"/>">
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/magnific-popup.css"/>">
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/bootsnav.css"/>">
	...
	<!--Theme custom css -->
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/style.css"/>">
	<!--<link rel="stylesheet" href="assets/css/colors/maron.css">-->

	<!--Theme Responsive css-->
	<link rel="stylesheet" href="<c:url value="/resources/ref/css/responsive.css"/>">
	
	<!-- slider -->
	>
	<script src="<c:url value="/resources/ref/js/vendor/modernizr-2.8.3-respond-1.4.2.min.js"/>"></script>
...
<body data-spy="scroll" data-target=".navbar-collapse">
		...
		<div class="featured_slider">
			<div>
				<div class="featured_img">
					<img src="<c:url value="/resources/ref/images/fprojects/1.jpg"/>">
					<a href="assets/images/fprojects/1.jpg" class="popup-img"></a>
				</div>
			</div>
			<div>
				<div class="featured_img">
				<img src="<c:url value="/resources/ref/images/fprojects/2.jpg"/>">
					<a href="assets/images/fprojects/2.jpg" class="popup-img"></a>
				</div>
			</div>
			<div>
				<div class="featured_img">
				<img src="<c:url value="/resources/ref/images/fprojects/3.jpg"/>">
					<a href="assets/images/fprojects/3.jpg" class="popup-img"></a>
				</div>
			</div>
			<div>
				<div class="featured_img">
				<img src="<c:url value="/resources/ref/images/fprojects/4.jpg"/>">
					<a href="assets/images/fprojects/4.jpg" class="popup-img"></a>
				</div>
			</div>
			<div>
				<div class="featured_img">
				<img src="<c:url value="/resources/ref/images/fprojects/5.jpg"/>">
	...
	<script src="<c:url value="/resources/ref/js/vendor/jquery-1.11.2.min.js"/>"></script>
	
	<script src="<c:url value="/resources/ref/js/vendor/popper.min.js"/>"></script>
	<script src="<c:url value="/resources/ref/js/vendor/bootstrap.min.js"/>"></script>

	<script src="<c:url value="/resources/ref/js/jquery.magnific-popup.js"/>"></script>
	<script src="<c:url value="/resources/ref/js/jquery.easing.1.3.js"/>"></script>
	<script src="<c:url value="/resources/ref/js/vendor/jquery-1.11.2.min.js"/>"></script>
	<script src="<c:url value="/resources/ref/js/slick.min.js"/>"></script>
	<script src="<c:url value="/resources/ref/js/jquery.collapse.js"/>"></script>
	<script src="<c:url value="/resources/ref/js/bootsnav.js"/>"></script>
...
<script src="<c:url value="/resources/ref/js/plugins.js"/>"></script>
<script src="<c:url value="/resources/ref/js/main.js"/>"></script>
