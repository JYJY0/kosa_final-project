      ...
      <div class="l-wrapper">
        <header class="header">
          <a class="header--logo" href="#0">
            <img src="<c:url value="/resources/wellness/img/wellness_logo2.png"/>" alt="Global" width="100px">
            <p>의료진단</p>
          </a>
                  ...
                  <li class="slider--item">
						<a href="#0">
							<div class="slider--item-image">
								<img src="<c:url value="/resources/wellness/img/head1.png"/>" alt="Global">
							</div>
							<p class="slider--item-title">Alex Nowak</p>
							<p class="slider--item-description">Lorem ipsum dolor.</p>
						</a>
					</li>
					<li class="slider--item">
						<a href="#0">
							<div class="slider--item-image">
								<img src="<c:url value="/resources/wellness/img/skin1.png"/>" alt="Global">
							</div>
							<p class="slider--item-title">Alex Nowak</p>
							<p class="slider--item-description">Lorem ipsum dolor.</p>
						</a>
					...
					<li class="slider--item">
						<a href="#0">
							<div class="slider--item-image">
								<img src="<c:url value="/resources/wellness/img/face1.png"/>" alt="Global">
							</div>
							<p class="slider--item-title">Alex Nowak</p>
							<p class="slider--item-description">Lorem ipsum dolor.</p>
						</a>
