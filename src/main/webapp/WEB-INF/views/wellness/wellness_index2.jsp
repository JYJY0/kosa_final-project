          ...
          <li class="l-section section section--is-active">
            <div class="intro">
              <div class="intro--banner">
                ...
                <img src="<c:url value="/resources/wellness/img/introduction-visual.png"/>" alt="Welcome">
              </div>
          ...
          <li class="l-section section">
            <div class="about">
              <div class="about--banner">
                ...
                <img src="<c:url value="/resources/wellness/img/about-visual.png"/>" alt="About Us">
              </div>
